...
- Root Mean Squared Error (RMSE): calculate RMSE for each 4-week forecast chunks and calculate average RMSE of the whole model.
- Mean Absolute Error (MAE): similar calculations to RMSE.
...
![4 week forecast - Prophet additive](svgs/forecast_prophet_multi.svg){#fig-prophet_addi fig-align="center"}

:::

::: {.column width="50%"}

![4 week forecast - Prophet multiplicative](svgs/forecast_arimax_weather.svg){#fig-prophet_multi fig-align="center"}
...
![4 week forecast - Poisson autoregression 1-week lag](svgs/forecast_poisson_l1w.svg){#fig-poi_auto_1wl fig-align="center"}

## Poisson autoregression - different auto lags

![4 week forecast - Poisson autoregression different auto lags](svgs/forecast_poisson_all_lags.svg){#fig-poi_auto_all fig-align="center"}

## Poisson autoregression - temperature lags

![4 week forecast - Poisson autoregression 1-week lag, different temperature lags](svgs/forecast_poisson_all_t2m_lags.svg){#fig-poi_t2m_lags fig-align="center"}

## Poisson autoregression - precipitation lags

![4 week forecast - Poisson autoregression 1-week lag, different precipitation lags](svgs/forecast_poisson_all_precip_lags.svg){#fig-poi_precip_lags fig-align="center"}


## Poisson autoregression - relative humidity lags

![4 week forecast - Poisson autoregression 1-week lag, different relative humidity lags](svgs/forecast_poisson_all_rh_lags.svg){#fig-poi_rh_lags fig-align="center"}
