...
cl <- makeCluster(6)
clusterEvalQ(cl, suppressPackageStartupMessages(library(dplyr)))
clusterEvalQ(cl, suppressPackageStartupMessages(library(purrr)))
clusterEvalQ(cl, library(tscount))
clusterEvalQ(cl, library(tsibble))
clusterExport(cl, c(
  "incidence_weekly_weather_df", "recur_miso"
))


lag_dfs <- parLapply(1:52, \(lag){
