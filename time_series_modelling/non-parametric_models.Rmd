...
mean_fit %<>% mutate(
  n = distributional::dist_poisson(.mean),
  uppers = hilo(n)$upper,
  lowers = hilo(n)$lower
)
...
chunks_forecast_res_df <- chunks_forecast_perf(pre_perf_df, "MEAN", c("RMSE", "MAE"))
...
chunks_forecast_res_df <- chunks_forecast_perf(pre_perf_df, "NAIVE")
...
chunks_forecast_res_df <- chunks_forecast_perf(pre_perf_df, "Drift")
