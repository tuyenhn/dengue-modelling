...
dists <- unlist(nbdists(neighbors, hosp_coords_only))
summary(dists)
...
neigh_d1 <- dnearneigh(hosp_coords, d1 = 0, d2 = max_1n, row.names = hosp_coords$rowid)
# neighbors within 2X maximum distance
neigh_d2 <- dnearneigh(hosp_coords, d1 = 0, d2 = 2 * max_1n, row.names = hosp_coords$rowid)
...
plot(hosp_coords$lon, hosp_coords$lat, pch = 16)
plot(neigh_d1, hosp_coords_only, col = "green", add = T)
plot(hosp_coords$lon, hosp_coords$lat, pch = 16)
plot(neigh_d2, hosp_coords_only, col = "green", add = T)
```
