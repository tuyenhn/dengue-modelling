...
models_res <- read_csv("./grid_perfs/alpha_poisson_perfs.csv")
...
#| fig-cap: Poisson regression models with and without accumulation effect RMSE
#| echo: false
models_res %>%
